...
describe('Turn Ticket Dispenser', () => {
  ...
  it('should return a TurnTicket instance', () => {
    const dispenser = new TicketDispenser(sharedSequence );
  ...
  it('should share the same sequence across different dispensers', () => {
    const dispenserA = new TicketDispenser(sharedSequence );
    const dispenserB = new TicketDispenser(sharedSequence );
